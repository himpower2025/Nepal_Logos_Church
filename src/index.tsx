        ...
        <div className="page-content chat-list-page">
            ...
            <div className="list-container">
                {chats.map(chat => {
                    ...
                    const lastMessageCreatedAt = chat.lastMessage?.createdAt;

                    // More robust check for valid Timestamp objects to prevent crashes
                    ...
                    if (isLastMessageTimestampValid) {
                        ...
                        if (isLastReadTimestampValid) {
                            ...
                            isUnread = true; // If user has never read, it's unread
                        }
                    }
