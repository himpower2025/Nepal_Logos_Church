...
const MCCHEYNE_READING_PLAN = [
    ...
    "१ इतिहास २२, लूका ५, हितोपदेश १४, भजनसंग्रh ८２",
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <form className="modal-form" onSubmit={handleSubmit}>
                ...
                <ImageUpload 
                    ...
                    currentImageUrl={newsItem?.thumbnailUrl ||
                newsItem?.image) ? (newsItem.thumbnailUrl || newsItem.image) : undefined}
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <form className="modal-form" onSubmit={handleSubmit}>
                ...
                <ImageUpload 
                    selectedFile={imageFile} 
                    setSelectedFile={setImageFile} 
                    currentImageUrl={request?.thumbnailUrl ||
                request?.image) ? (request.thumbnailUrl || request.image) : undefined}
                    label="फोटो थप्नुहोस्।(यदि तपाईं चाहनुहुन्छ भने)"
                    onImageRemove={() => setImageRemoved(true)}
                />
                <button type="submit" className="action-button">
...
class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    // FIX: The original code `const { children } = this.props; return children;` was causing a
    // "Property 'props' does not exist on type 'ErrorBoundary'" error, likely due to a
    // subtle TypeScript type inference issue. Directly returning `this.props.children` resolves this.
