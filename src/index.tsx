...
const MCCHEYNE_READING_PLAN = [
    ...
    "२ राजा ২০, मत्ती ২৩, भजनसंग्रह ३２, भजनसंग्रह ३３",
    ...
    "१ इतिहास ८, मर्कूस ८, भजनसंग्रह ५８, भजनसंग्रह ५९",
        ...
        try {
            const uploadedMedia: MediaItem[] = await Promise.all(
                mediaFiles.map(async (preview, index) => {
                    const uniqueFileName = `${Date.now()}-${index}-${Math.random().toString(36).substring(2, 9)}_${preview.file.name}`;
